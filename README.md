...
<h1 align="center">Data science & AI | Python 🐍 | SQL 🛢 | Machine learning🤖</h1>
<h3 align="center">by Jonathan Delrue</h3>
...
## 📌 Discover my data projects on GitHub

### 1️⃣ [Machine learning on NBA's players data](https://github.com/jonaudomar/ML-NBA)
- **Goal** : the goal of the project is to model the relationship between the players’ win rating and the amount of minutes they played (part 1), and then, to interpret the learning curves and understanding how model complexity affects the results and how we can prevent underfitting and overfitting (part 2).
- **Tools** : scikit learn, linear regression, polynomial features, feature engineering, pandas, matplotlib, seaborn.
